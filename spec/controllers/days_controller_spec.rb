...
describe DaysController do
  ...
  let(:valid_attributes) { { "date" => "2013-07-27" } }
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved day as @day" do
        ...
        post :create, {:day => { "date" => "invalid value" }}, valid_session
        assigns(:day).should be_a_new(Day)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested day" do
        ...
        Day.any_instance.should_receive(:update).with({ "date" => "2013-07-27" })
        put :update, {:id => day.to_param, :day => { "date" => "2013-07-27" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the day as @day" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Day.any_instance.stub(:save).and_return(false)
        put :update, {:id => day.to_param, :day => { "date" => "invalid value" }}, valid_session
        assigns(:day).should eq(day)
      end
